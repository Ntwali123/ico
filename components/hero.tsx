        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-white/10 rounded-full px-4 py-2">
              ...
              <span className="text-gray-300">For the Black Friday weekend</span>
            </div>
          ...
          >
            <h2 className="text-3xl font-bold text-center mb-8">Token Sale End In</h2>
              ...
              <div className="w-full h-3 bg-gray-700 rounded-full overflow-hidden">
                ...
                >
                  <div className="relative">
                    <span className="absolute -top-6 right-0 text-xs bg-pink-500 px-2 py-1 rounded">60,490</span>
                  </div>
                </div>
              </div>
